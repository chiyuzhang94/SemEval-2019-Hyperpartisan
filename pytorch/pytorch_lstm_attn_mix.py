...
##########################################################
with open('./output/bilstmattn_mix/bilstmattn_tokenizer.pickle', 'rb') as handle:
    tokenizer = pickle.load(handle)
load_model = True
...
##########################################################
with open(outpath+'lstmattn_tokenizer.pickle', 'wb') as handle:
