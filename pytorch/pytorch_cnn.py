...
with open('./output/cnn/train_loss_cnn_w2v.json', 'w') as outfile1:
    json.dump(training_loss, outfile1)  # write training loss results to a json file

with open('./output/cnn/test_accuracy_cnn.json', 'w') as outfile2:
    json.dump(test_acc, outfile2) # write test accuracy results to a json file

with open('./output/cnn/train_accuracy_cnn.json', 'w') as outfile3:
