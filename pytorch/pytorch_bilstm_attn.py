...
load_model = False
load_model_path = "./output/bilstmattn_auto/pytorch_bilstmattn_4"

model_name = "bilstmattn"
outpath = './output/bilstmattn_auto/'
...
data_size = 90 # The whole dataset is composed of data_size articles.
auto_data_size = 80 # train_size articles is used as training data.
auto_testdata_size = 10 # test_size articles is used as testing data.
# Hyper Parameters
...
if load_model:
    ...
    lstmattn_checkpoint = torch.load(load_model_path,map_location='cpu')
...
with open(outpath+'test_accuracy_lstmattn.json', 'w') as outfile2:
    json.dump(test_acc, outfile2) # write test accuracy results to a json file

with open(outpath+'train_accuracy_lstmattn.json', 'w') as outfile3:
